...
import asyncio
import functools
from asr.utils import AudioStreaming
...
parser.add_argument("--overlap", "-ov", default=0, type=int, required=False,
                    help="Overlapping amount in audio blocks")
...
async def main(output_file=None):
    ...
    stream = AudioStreaming(audio_path=args.recording, blocksize=args.blocksize,
                            overlap=args.overlap, loop=loop)
